...
<form action="<?php echo e(route('admin.product.update')); ?>" enctype="multipart/form-data" method="post">
    <?php echo csrf_field(); ?>
    <div class="admin-content-main-content">
        <div class="admin-content-main-content-left">
            <div class="admin-content-main-content-tow-input">
                <input type="hidden" name="id" value="<?php echo e($product->id); ?>">
                <input type="text" value="<?php echo e($product -> name); ?>" name="name" placeholder="Tên sản phẩm" />
                <input type="text" value="<?php echo e($product -> material); ?>" name="material" placeholder="Chất liệu" />
            </div>
            <div class="admin-content-main-content-tow-input">
                <input type="text" value="<?php echo e($product -> price_nomal); ?>" name="price_nomal" placeholder="Giá bán" />
                <input type="text" value="<?php echo e($product -> price_sale); ?>" name="price_sale" placeholder="Giá giảm" />
            </div>
            <textarea class="editor" name="description"><?php echo e(html_entity_decode($product->description)); ?></textarea>
        <textarea class="editor1" name="content"><?php echo e(html_entity_decode($product->content)); ?></textarea>
        ...
        <div class="admin-content-main-content-right">
            <div class="admin-content-main-content-right-img">
                ...
                <input id="image" type="file" name="image" value="<?php echo e($product->image); ?>"/>
            ...
            <div class="admin-content-main-content-right-imgs">
                ...
                <div class="images-show" id="input-file-imgs">
                    ...
                    ?>
                    <?php $__currentLoopData = $product_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Sửa lại biến lặp là $product_images -->
...
<?php echo $__env->make('admin.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Wed_thethaoProject2\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>