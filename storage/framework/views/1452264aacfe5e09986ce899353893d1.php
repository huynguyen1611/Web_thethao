        ...
        <div class="row-grid row-grid-hot-product">
            <?php $__currentLoopData = $newProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="hot-product-item">
                    <a href="/frontend/product/<?php echo e($product->id); ?>"><img src="<?php echo e(asset($product->image)); ?>"
                            alt="" /></a>
...
<?php /**PATH C:\wamp64\www\Wed_thethaoProject2\resources\views/frontend/parts/product_new.blade.php ENDPATH**/ ?>